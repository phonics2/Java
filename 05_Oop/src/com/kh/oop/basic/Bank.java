...
public class Bank {
	...
	public Bank(String 이름, String 계좌번호, int 잔액, String 비밀번호, boolean 수신동의) {
		this.name = 이름;
	...
	public static void main(String[]args) {
		...
		Bank customer3 = new Bank("마이클","11123-345-456",456,"1234",true);
		//이름 계좌번호 잔액 비밀번호 를 입려하고
		//마케팅 수신동의를 true 변경해서 출력하
		customer3.info();

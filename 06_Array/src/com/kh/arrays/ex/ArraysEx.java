...
/*
 ...
 asList() : 배열을 리스트로 변환해서 추가 배열을 수정하기 않고 배열의 내용을 감싸서 보여줌
 
 String[] 배열 = {"사과", "바나나"};
 
 //List 계열에 추가할 때
  ArrayList<String> 리스트 = Array.asList(배열);
  ArrayList<String> 리스트 = Array.asList("사과", "바나나");
...
public class ArraysEx {
	...
	public static void main(String[] args) {
		...
		System.out.println("num복사된 abc : " + Arrays.toString(abc));

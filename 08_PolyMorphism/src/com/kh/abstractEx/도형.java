...
//메서드
	...
	/*abstract 나중에 설계도로 완성할 파일에서 필수로 불러줘서 완성해야하는메서드들
	
	 abstract 메서드는 미완성 메서드이기 때문에 자식클래스에서
	 미완성된 부모클래스를 완성시켜주기 위해 자식이 부모를 불러올 때,
	 abstract 같은 경우에는 자식에서 필수로 불러온 다음 메서드 모양을 완성해야함.
	 */

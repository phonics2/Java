...
public class DateEx {
	public static void main(String[] args) {
		...
		/* 3. GregorianCalendar
		 그레고리안 달력은 1녈 1월 1일 무조건 월요일로 정의되어있음
		 2024, 4, 23 을 하면 자동으로 2024년 5월 23일로 변경됨
		 2024년 5월 23일은 목요일
		 */
		GregorianCalendar 그레고리안1 = new GregorianCalendar();
		GregorianCalendar 그레고리안2 = new GregorianCalendar(2024, 4, 23);// 2024년 5월 23일 로 될것
		int 날짜 = 그레고리안2.get(Calendar.DAY_OF_WEEK);//일(1) 월(2) 화(3) 수(4) 목(5) 금(6) 토(7)
		System.out.println("날짜 : " + 날짜);//4월 23일이 목요일이기 때문에 5라고 나오는 것
		...
		/*4. SimpleDateFormat 년 월 일
		 ...
		 일 : d		  day
		 시 : H		  Hour (H : 0 ~ 23시     h : 오전(am) 오후(pm)로 나눠서 표기
		 분 : m		  minute
		 초 : s		  second
		 
		 요일 : E E라는 글자로 표기하자 국제 표준화 기구에서 약속
		 만약에 O요일을 쓰고 싶다면 EEEE 를 사용
		*/

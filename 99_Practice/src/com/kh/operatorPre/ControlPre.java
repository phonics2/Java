...
public class ControlPre {
	...
	public static void practice3() {
		...
		case 2:
			...
			break;
		default:
			System.out.println(month + "월은 존재하지 않는 월 입니다.");
			return;
